...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        self.regularizedRandomForest_checkbox.setGeometry(
            QtCore.QRect(190, 30, 156, 17)
        )
        self.regularizedRandomForest_checkbox.setObjectName(
            "regularizedRandomForest_checkbox"
        )

        self.guidedRegularizedRandomForest_checkbox = QtWidgets.QCheckBox(self.FSFrame)
        self.guidedRegularizedRandomForest_checkbox.setGeometry(
            QtCore.QRect(190, 60, 211, 17)
        )
        self.guidedRegularizedRandomForest_checkbox.setObjectName(
            "guidedRegularizedRandomForest_checkbox"
        )
        ...
        self.infiniteLatenFeatureSelection_checkbox.setGeometry(
            QtCore.QRect(190, 150, 181, 17)
        )
        self.infiniteLatenFeatureSelection_checkbox.setObjectName(
            "infiniteLatenFeatureSelection_checkbox"
        )
        ...
        self.eigenvectorCentrality_checkbox.setObjectName(
            "eigenvectorCentrality_checkbox"
        )
    ...
    def on_click_browse_feature(self):  # feature file button click
        ...
        if self.featureFilePath:  # This outputs the path for reference
            ...
            self.features, self.featuresLength = main.load_features(
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sparseGroupLASSO_checkbox.setText(
            _translate("MainWindow", "Sparse Group LASSO")
        )
        ...
        self.alphaInvesting_checkbox.setText(
            _translate("MainWindow", "alpha-investing")
        )
        self.minMaxMarkovBlanket_checkbox.setText(
            _translate("MainWindow", "Min-Max Markov Blanket")
        )
        ...
        self.gradientBoosting_checkbox.setText(
            _translate("MainWindow", "Gradient Boosting")
        )
        self.regularizedRandomForest_checkbox.setText(
            _translate("MainWindow", "Regularized Random Forest")
        )
        self.guidedRegularizedRandomForest_checkbox.setText(
            _translate("MainWindow", "Guided Regularized Random Forest")
        )
        self.RFgroove_checkbox.setText(_translate("MainWindow", "RFgroove"))
        self.infFS_checkbox.setText(_translate("MainWindow", "Inf-FS"))
        self.infiniteLatenFeatureSelection_checkbox.setText(
            _translate("MainWindow", "Infinite Latent Feature Selection")
        )
        self.eigenvectorCentrality_checkbox.setText(
            _translate("MainWindow", "Eigenvector Centrality")
        )
        self.quickReduct_checkbox.setText(_translate("MainWindow", "Quick Reduct"))
        self.FSDAARHueristicRST_checkbox.setText(
            _translate("MainWindow", "FS.DAAR.hueristic.RST")
        )
        self.FSnearOptfvprsFRST_checkbox.setText(
            _translate("MainWindow", "FS.nearOpt.fvprs.FRST")
        )
